          ...
          <div className="bg-white/90 backdrop-blur-xl rounded-3xl p-6 shadow-2xl border border-white/50 relative z-10">
            ...
            <div className="space-y-3 font-mono text-sm bg-gray-50/80 p-4 rounded-xl border border-gray-100">
              <div className="flex gap-4">
                ...
                <span className="text-purple-600">const</span> <span className="text-indigo-600">You</span> = {"{"}
              </div>
              <div className="flex gap-4">
                <span className="text-gray-400">2</span>
                <span className="pl-4 text-gray-600">skills</span>: [<span className="text-green-600">"Solidity"</span>, <span className="text-green-600">"React"</span>],
              </div>
              <div className="flex gap-4">
                <span className="text-gray-400">3</span>
                <span className="pl-4 text-gray-600">verified</span>: <span className="text-blue-600">true</span>,
              </div>
              <div className="flex gap-4">
                <span className="text-gray-400">4</span>
                <span className="pl-4 text-gray-600">offers</span>: <span className="text-orange-500">5</span>
              </div>
              <div className="flex gap-4">
            ...
            <div className="absolute -bottom-6 -left-6 bg-white p-4 rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.1)] border border-gray-100 w-64 animate-in slide-in-from-bottom-4 fade-in duration-1000">
              <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  <p className="text-sm font-bold text-gray-900">Interview Request</p>
                  <p className="text-xs text-gray-500">Senior Frontend @ Nexus</p>
                </div>
              </div>
            ...
            <div className="absolute -right-8 top-20 bg-white p-4 rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.1)] border border-gray-100 w-60 animate-in slide-in-from-right-4 fade-in duration-1000 delay-300">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-bold text-gray-900">@Alex_Dev</p>
                  <p className="text-xs text-gray-500">"Sent you 50 MATIC!"</p>
                </div>
              </div>
            </div>
